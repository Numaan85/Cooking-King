...
const Navbar = ({
  ...
  return (
    <div className='navbar flex justify-between items-center container mx-auto py-8 flex-col gap-5 lg:flex-row lg:gap-0'>
      <h2 className='logo text-2xl font-bold italic uppercase'>
        <Link to="/">
      ...
      <form className='search-bar' onSubmit={searchHandler}>
        <input
          ...
          required
          className='bg-white/75 p-3 px-8 rounded-lg outline-none shadow-lg shadow-lime-300 lg:w-96 focus:shadow-rose-200 duration-300'
        />
      </form>
